...
namespace Microsoft.eShopWeb.Web
{
    public class Startup
    {
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddScoped(sp => endpoints);
            
            IQueueClient queueClient = new QueueClient(endpoints.ServiceBus, "ordersmessages");
            services.AddScoped(sp => queueClient);
        ...
        public void ConfigureProductionServices(IServiceCollection services)
        {
            ...
            /*var connectionString = Configuration["ConnectionStrings:CatalogConnection"]*/;
